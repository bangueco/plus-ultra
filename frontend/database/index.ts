    ...
    try {
      await this.db.execAsync(`
        ...
        VALUES
          ...
          ('Dumbbell Shoulder Press', 'An overhead press exercise that primarily targets the shoulders.', 'https://www.example.com/', 'Dumbbells', 'Shoulders, Triceps', 'Shoulders'),
          ('Lateral Raise', 'An isolation exercise for the deltoid muscles, primarily targeting the lateral head.', 'https://www.example.com/', 'Dumbbells', 'Shoulders', 'Shoulders'),
          ...
          ('Romanian Deadlift', 'A deadlift variation that primarily targets the hamstrings and glutes.', 'https://www.example.com/', 'Barbell or Dumbbells', 'Hamstrings, Glutes', 'Legs'),
          ...
          ('Reverse Fly', 'An exercise that targets the rear deltoids and upper back.', 'https://www.example.com/', 'Dumbbells', 'Shoulders, Upper Back', 'Shoulders'),
          ('Bench Press', 'A compound exercise that targets the chest, shoulders, and triceps.', 'https://www.example.com/', 'Barbell or Dumbbells', 'Chest, Shoulders, Triceps', 'Chest'),
